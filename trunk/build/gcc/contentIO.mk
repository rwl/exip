...
$(CONTENT_IO_BIN)/headerEncode.o : $(PUBLIC_INCLUDE_DIR)/headerEncode.h $(CONTENT_IO_SRC)/src/headerEncode.c
...
$(CONTENT_IO_BIN)/EXISerializer.o : $(PUBLIC_INCLUDE_DIR)/EXISerializer.h $(CONTENT_IO_SRC)/src/EXISerializer.c
