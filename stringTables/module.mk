...
$(STRING_TABLES)/test: $(COMMON)/lib$(COMMON).a $(STRING_TABLES)/lib$(STRING_TABLES).a $(STRING_TABLES)/tests/check_streamIO.c
		$(CC) $(CFLAGS) $(STRING_TABLES)/tests/check_streamIO.c $(COMMON)/lib$(COMMON).a $(STRING_TABLES)/lib$(STRING_TABLES).a \
