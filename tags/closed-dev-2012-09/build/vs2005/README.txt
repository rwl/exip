 ...
 * @version 0.1
 * @par[Revision] $Id: README.txt 35 2011-01-28 15:40:00Z sguilbard $
 */

Efficient XML Interchange Processor/Visual Studio 2005 Build
...
Compatibility:
 ...
 - Compiler: Visual Studio 2005 C++ + Service Pack 1
 
 - Platform: Tested on Windows 7 Entreprise 64 bits (Build 6.1.7600)
 
 
 Notes:
 
 Visual Studio 2005 does not support C99 standard.
 
 Porting exip to VS2005 raised the following issues;
