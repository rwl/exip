...
$(TESTS_BIN_DIR)/test_$(GRAMMAR): common streamIO grammar stringTables contentIO grammarGen $(TESTS_SRC_DIR)/check_grammar.c
        ...
        $(COMMON_BIN)/lib$(COMMON).a $(GRAMMAR_GEN_BIN)/lib$(GRAMMAR_GEN).a $(CHECK_DIR)/libcheck.a $(STRING_TABLES_BIN)/lib$(STRING_TABLES).a -o $(TESTS_BIN_DIR)/test_$(GRAMMAR)
...
$(TESTS_BIN_DIR)/test_$(CONTENT_IO): contentIO common streamIO grammarGen $(TESTS_SRC_DIR)/check_contentIO.c
		$(CC) $(CFLAGS) $(TESTS_SRC_DIR)/check_contentIO.c $(CONTENT_IO_BIN)/lib$(CONTENT_IO).a $(COMMON_BIN)/lib$(COMMON).a $(STREAM_IO_BIN)/lib$(STREAM_IO).a $(CHECK_DIR)/libcheck.a $(GRAMMAR_GEN_BIN)/lib$(GRAMMAR_GEN).a -o $(TESTS_BIN_DIR)/test_$(CONTENT_IO)