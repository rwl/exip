...
$(TESTS_BIN_DIR)/test_$(GRAMMAR): common streamIO grammar stringTables $(TESTS_SRC_DIR)/check_grammar.c
		$(CC) $(CFLAGS) $(TESTS_SRC_DIR)/check_grammar.c $(GRAMMAR_BIN)/lib$(GRAMMAR).a $(STREAM_IO_BIN)/lib$(STREAM_IO).a \
