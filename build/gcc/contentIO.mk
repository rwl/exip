...
$(CONTENT_IO_BIN)/bodyEncode.o : $(CONTENT_IO_SRC)/include/bodyEncode.h $(CONTENT_IO_SRC)/src/bodyEncode.c
		$(CC) -c $(CFLAGS) $(CONTENT_IO_SRC)/src/bodyEncode.c -o $(CONTENT_IO_BIN)/bodyEncode.o