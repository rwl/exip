...
$(CONTENT_IO_BIN)/EXIParser.o : $(CONTENT_IO_SRC)/include/EXIParser.h $(CONTENT_IO_SRC)/src/EXIParser.c
		$(CC) -c $(CFLAGS) $(CONTENT_IO_SRC)/src/EXIParser.c -o $(CONTENT_IO_BIN)/EXIParser.o
		
$(CONTENT_IO_BIN)/EXISerializer.o : $(CONTENT_IO_SRC)/include/EXISerializer.h $(CONTENT_IO_SRC)/src/EXISerializer.c
